...
Relational databases are a type of database where as SQL is a language used to inferface with databases

- [ ] Why do tables need a `primary key`?
A primary key lets us have a unique identifier for individual entries in our database
...
Another table to act as a middle-man
